...
class TradingBot:
    ...
    def job(self):
        ...
        trend, support, resistance = self.strategy.scalping_strategy(df)
        if trend:
            ...
            # Stop-loss and take-profit based on scalping rules (tight stop-loss)
            stop_loss, take_profit = self.risk_management.calculate_scalping_risk_management(current_price, trend)
